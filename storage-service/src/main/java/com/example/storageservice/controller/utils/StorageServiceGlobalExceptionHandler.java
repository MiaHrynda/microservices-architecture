package com.example.storageservice.controller.utils;

import com.example.storageservice.dto.RESTExceptionDTO;
...
@ResponseBody
@ControllerAdvice
public class StorageServiceGlobalExceptionHandler extends ResponseEntityExceptionHandler {
